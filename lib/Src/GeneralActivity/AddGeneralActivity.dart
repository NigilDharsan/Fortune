...
class AddgeneralactivityScreen extends ConsumerStatefulWidget {
  const AddgeneralactivityScreen({super.key});

  @override
  ConsumerState<AddgeneralactivityScreen> createState() =>
      _AddgeneralactivityState();
}
