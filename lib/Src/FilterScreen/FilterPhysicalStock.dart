...
class FilterPhysicalStock extends StatefulWidget {
  Filter? filter;

  FilterPhysicalStock({super.key, required this.filter});

  @override
  State<FilterPhysicalStock> createState() => _FilterPhysicalStockState();
}

class _FilterPhysicalStockState extends State<FilterPhysicalStock> {
  String? Degree;
  String? clientName;
  String? companyName;
  String? selectStatus;
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Column(
                  children: [
                    singleton.permissionList.contains("stock-date-filter") ==
                            true
                        ? Column(
                            children: [
...
// DATE RANGE
                    ...
                    //COMPANY NAME
                    singleton.permissionList.contains("stock-company-filter") ==
                            true
                        ? Column(
                            children: [
                              Title_Style(
