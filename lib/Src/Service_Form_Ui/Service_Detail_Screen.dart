...
class _Service_Detail_ScreenState extends State<Service_Detail_Screen> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //CLIENT NAME
                      _Sub_Heading(
                          subHeadingT: "Client Name", contentT: "Jhon"),
                      //CLINET NUMBER
                      _Sub_Heading(
                          subHeadingT: "Client Number", contentT: "9095379095"),
                      _Sub_Heading(
                          subHeadingT: "Client Address",
                          contentT:
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          'The service still under working and wait for payment',
                          style: phoneHT,
                          maxLines: 2,
                        ),
                      ),
  ...
  Widget PdfContainer() {
    return Container(
      ...
      decoration:
          BoxDecoration(borderRadius: BorderRadius.circular(5), color: white2),
      child: Row(
        children: [
          Padding(
