...
class Custom_AppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  bool? isGreen;
  List<Widget>? actions;
  Custom_AppBar({Key? key, required this.title,required this.actions,required this.isGreen,required this.isNav})
      ...
      AppBar(
        ...
        InkWell(
          onTap: ()=>Navigator.pop(context),
            child: Icon(Icons.arrow_back_ios,color: widget.isGreen==true?white1:Colors.black,)):null,
        centerTitle: true,
